...
<<<<<<< HEAD
      ...
      const stream = await navigator.mediaDevices.getUserMedia({ 
        video: { 
          width: { ideal: 720, min: 600 },
          height: { ideal: 960, min: 800 },
          facingMode: 'user',
...
<<<<<<< HEAD
        ...
        // Scale to meet minimum requirements while maintaining aspect ratio
        let canvasWidth = Math.max(videoWidth, minWidth);
        let canvasHeight = Math.max(videoHeight, minHeight);
