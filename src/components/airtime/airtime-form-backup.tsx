  ...
  const handleConfirmPurchase = async () => {
    ...
    try {
        ...
        const receiptData = {
            ...
            transactionId: result.transaction_id || clientReference,
        ...
        // Navigate with receipt data in URL
        const receiptParams = {
            type: 'airtime',
        ...
        const queryString = Object.entries(receiptParams)
...
export function AirtimeFormBackup() {
    return (
        <>
