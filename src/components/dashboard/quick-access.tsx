    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-4">
        {largeFeatures.map((feature) => (
          <CustomLink href={feature.href} key={feature.label} className="bg-card p-4 rounded-xl shadow-sm flex flex-col items-center justify-center text-center hover:bg-muted transition-colors">
      ...
      <div className="grid grid-cols-4 gap-3">
         {smallFeatures.map((feature) => (
          <CustomLink href={feature.href} key={feature.label} className="bg-card p-2 rounded-xl shadow-sm flex flex-col items-center justify-center text-center h-24 hover:bg-muted transition-colors">
