        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <Card className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Stay informed about your financial activity</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <Label htmlFor="debit-alert-switch" className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">Debit Alerts</p>
          ...
          <Card className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Receive updates about your account</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 border rounded-lg">
