      ...
      <div className="flex-1 p-4 sm:p-8 pt-6 bg-slate-50">
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button onClick={handleSave} disabled={isLoading} className="bg-[#0b1b3a] hover:bg-[#0f2552] text-white">
          ...
          <div className="flex flex-col items-center gap-4 py-6">
            <div className="relative">
              <Avatar className="h-32 w-32 border-4 border-white shadow-lg">
                ...
                <AvatarFallback className="bg-gradient-to-r from-[#0b1b3a] via-[#0f2552] to-[#0b1b3a] text-white text-3xl font-semibold">
                  {initials}
                </AvatarFallback>
              </Avatar>
              <input
              ...
              <button 
                ...
                className="absolute bottom-0 right-0 p-2 bg-[#0b1b3a] rounded-full text-white shadow-lg hover:bg-[#0f2552] transition-colors disabled:opacity-50"
              >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 border-slate-200 focus:border-[#0b1b3a]"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled
                  className="pl-10 h-12 border-slate-200 bg-slate-50 cursor-not-allowed"
                />
              </div>
            </div>
