        ...
        <TabsContent value="dashboard">
          <Card className="bg-primary text-primary-foreground shadow-lg rounded-2xl my-4">
            <CardContent className="p-4">
                <div className="flex justify-between items-center text-sm text-primary-foreground/80 mb-1">
                ...
                <div className="flex justify-between items-end">
                    ...
                    <Link href="/add-money" className="bg-primary-foreground/20 text-white text-xs font-semibold px-3 py-1.5 rounded-full">+ Add Money</Link>
                </div>
            </CardContent>
          </Card>
          <QuickAccess />
